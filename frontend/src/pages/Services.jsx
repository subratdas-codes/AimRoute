...
const Services = () => {
  ...
  const personas = [
    {
      ...
      color: "from-blue-500 to-cyan-500", bg: "bg-blue-50", border: "border-blue-200", tag_color: "bg-blue-100 text-blue-700",
    },
    {
      emoji: "📚", level: "After 12th",
      ...
      color: "from-purple-500 to-violet-600", bg: "bg-purple-50", border: "border-purple-200", tag_color: "bg-purple-100 text-purple-700",
    },
    {
      emoji: "🎓", level: "After Graduation",
      ...
      color: "from-emerald-500 to-teal-500", bg: "bg-emerald-50", border: "border-emerald-200", tag_color: "bg-emerald-100 text-emerald-700",
    },
    {
      emoji: "🔬", level: "Post Graduation",
      ...
      color: "from-amber-500 to-orange-500", bg: "bg-amber-50", border: "border-amber-200", tag_color: "bg-amber-100 text-amber-700",
    },
  ];

  // ── navTo controls where "Try it now" goes in the modal ──────
  const services = [
    { icon:"🤖", title:"AI Career Matching",       tag:"Personalised to you",        navTo:"/career-path",
      short:"Your answers shape your result — no two students get the same output.",
      detail:"Our AI evaluates your interests and strengths across 4 categories — Technology, Business, Creative, and Healthcare. It matches you to careers that genuinely fit your profile, not just your stream.",
      grad:"from-purple-500 to-violet-600",  bg:"hover:bg-purple-50",  border:"hover:border-purple-200" },
    { icon:"📋", title:"Smart Quiz",               tag:"Scenario-based",              navTo:"/career-path",
      short:"Real-life scenarios — not textbook questions. No right or wrong answers.",
      detail:"Instead of asking 'what's your favourite subject?', we ask how you'd react in real situations. Each question maps to a career category. The quiz takes under 3 minutes.",
      grad:"from-blue-500 to-cyan-500",      bg:"hover:bg-blue-50",    border:"hover:border-blue-200" },
    { icon:"🗺️", title:"Personalised Roadmap",     tag:"Step by step",               navTo:"/career-path",
      short:"A clear path from where you are today to your target career.",
      detail:"After your result, you get a step-by-step roadmap specific to your level and career match. It shows what exams to clear, what skills to build, and how long each stage takes.",
      grad:"from-pink-500 to-rose-500",      bg:"hover:bg-pink-50",    border:"hover:border-pink-200" },
    { icon:"🏫", title:"College Suggestions",       tag:"6,554 NIRF colleges",        navTo:"/career-path",
      short:"Real colleges filtered by your career, state, and percentage.",
      detail:"We use real data from 6,554 NIRF-ranked institutions across India. Colleges are filtered by your career match, your state, and whether your percentage meets the cutoff.",
      grad:"from-emerald-500 to-teal-500",   bg:"hover:bg-emerald-50", border:"hover:border-emerald-200" },
    { icon:"🎓", title:"Exam Eligibility Checker",  tag:"20+ competitive exams",      navTo:"/dashboard",
      short:"Know which entrance exams you qualify for — right now.",
      detail:"Based on your level and percentage, we instantly show which exams you're eligible for — JEE, NEET, CAT, CLAT, GATE, UPSC, NDA, IBPS, NIFT and more. Each card shows date, age limit, and official link.",
      grad:"from-amber-500 to-orange-500",   bg:"hover:bg-amber-50",   border:"hover:border-amber-200" },
    { icon:"💾", title:"Dashboard & History",       tag:"Save and track",             navTo:"/dashboard",
      short:"Save your results, track attempts, and download your career report.",
      detail:"Create a free account to save results to your dashboard. See all past attempts, compare across levels, and download your career report as PDF or CSV.",
      grad:"from-indigo-500 to-purple-600",  bg:"hover:bg-indigo-50",  border:"hover:border-indigo-200" },
    { icon:"💰", title:"Scholarship Finder",        tag:"Free money for students",    navTo:"/dashboard",
      short:"Discover scholarships you are eligible for based on your profile, state, and category.",
      detail:"We match your education level, category (General/OBC/SC/ST), state, and income group to real scholarships from central and state governments, private trusts, and NGOs. No more missing deadlines or unknown opportunities.",
      grad:"from-rose-500 to-pink-600",      bg:"hover:bg-rose-50",    border:"hover:border-rose-200" },
    { icon:"⚖️", title:"Career Comparison Tool",   tag:"Compare side by side",       navTo:"/compare",
      short:"Pick any two careers and see salary, path, exams, and job scope compared side by side.",
      detail:"Our comparison tool lets you put two careers next to each other — salary range, time to enter the field, required entrance exams, key skills, and job scope. See an AI-calculated overall winner based on your profile.",
      grad:"from-violet-500 to-purple-600",  bg:"hover:bg-violet-50",  border:"hover:border-violet-200" },
  ];
  ...
  const comparison = [
    ...
    { feature:"Scholarship finder",       aimroute:true,  generic:false },
    { feature:"Career comparison tool",   aimroute:true,  generic:false },
  ...
  const testimonials = [
    { name:"Lipsa Kiran Sahoo",  level:"12th Grade · PCB Stream",     photo:lipsaPhoto,   color:"from-purple-500 to-pink-500",
      text:"I was stuck between MBBS and Allied Health Sciences. AimRoute showed me exactly which colleges matched my percentage. The whole decision felt less overwhelming." },
    { name:"Kamlesh Nayak",      level:"Graduation · BTech CSE",       photo:kamleshPhoto, color:"from-blue-500 to-cyan-500",
      text:"After BTech I didn't know whether to go for GATE, MBA, or a job. The roadmap AimRoute gave was specific to my profile — not the same generic advice you get everywhere." },
    { name:"Subrat Das",         level:"After 10th · Commerce Stream", photo:subratPhoto,  color:"from-emerald-500 to-teal-500",
      text:"Everyone said take Science, but AimRoute showed Commerce with CA was a much better fit. The college suggestions for Odisha were really accurate too." },
    { name:"Jyoti Ranjan Panda", level:"Post Graduation · MBA",        photo:jyotiPhoto,   color:"from-amber-500 to-orange-500",
      text:"The exam eligibility checker instantly told me which management entrance exams I qualify for. Saved me hours of research across different websites." },
  ];
  ...
  const faqs = [
    ...
    { q:"How is AimRoute different from other career tests?", a:"Most tests give a generic personality type. AimRoute gives specific career paths, real colleges matching your percentage and state, eligible exams, scholarship finder, career comparison, and a step-by-step roadmap — all in one place." },
  ];
  ...
  return (
    <div className="bg-white overflow-x-hidden">
            ...
            <div className="space-y-7">
              ...
              <div>
                ...
                <p className="text-gray-500 text-lg leading-relaxed max-w-lg">
                  One platform that covers every student — from 10th grade confusion to post-graduation pivots.
                  AI-powered, data-backed, completely free.
                </p>
              </div>
              <div className="flex flex-wrap gap-2">
                {["🤖 AI Matching","🏫 6K+ Colleges","🗺️ Roadmap","🎓 Exam Checker","⚖️ Compare Careers","💰 Scholarships","💾 Dashboard"].map((f,i)=>(
                  <span key={i} className="text-xs bg-white border border-purple-200 text-purple-700 px-3 py-1.5 rounded-full font-semibold shadow-sm">{f}</span>
                ))}
              </div>
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <span className="inline-block bg-purple-100 text-purple-700 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4">Who Is It For</span>
            <h2 className="text-4xl font-black text-gray-900 mb-4">Built for Every Stage</h2>
            <p className="text-gray-500 max-w-lg mx-auto">Whether you just finished 10th or completed your master's — AimRoute has a specific path for exactly where you are.</p>
          </div>
          <div className="flex justify-center gap-3 flex-wrap mb-10">
            {personas.map((persona,i)=>(
              <button key={i} onClick={()=>setActivePersona(i)}
                ...
                <span>{persona.emoji}</span>{persona.level}
              </button>
            ))}
          </div>
            ...
            <div className={`bg-white rounded-3xl border-2 ${p.border} overflow-hidden shadow-xl`}>
              <div className={`bg-gradient-to-r ${p.color} px-8 py-6`}>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center text-4xl">{p.emoji}</div>
                  <div>
              ...
              <div className={`px-8 py-5 ${p.bg} border-t-2 ${p.border} flex flex-wrap items-center justify-between gap-4`}>
                <div className="flex gap-2 flex-wrap">
                  {p.tags.map((tag,i)=>(
                    <span key={i} className={`text-xs font-bold px-3 py-1.5 rounded-full ${p.tag_color}`}>{tag}</span>
                  ))}
                </div>
                <button onClick={()=>navigate("/career-path")}
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="inline-block bg-purple-100 text-purple-700 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4">The Process</span>
            <h2 className="text-4xl font-black text-gray-900 mb-4">How AimRoute Works</h2>
            <p className="text-gray-500 max-w-lg mx-auto">From your first question to a personalised career result — in under 3 minutes.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-5">
            {steps.map((s,i)=>(
              <div key={i}
                ...
                <div className="text-xs font-black text-gray-300 mb-4 tracking-widest">STEP {String(i+1).padStart(2,"0")}</div>
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mb-4 bg-gradient-to-br ${s.color} shadow-md`}>{s.icon}</div>
                <h3 className="font-bold text-gray-800 mb-2 text-base">{s.title}</h3>
                <p className="text-gray-500 text-sm leading-relaxed">{s.desc}</p>
                {activeStep===i && <div className="absolute bottom-5 right-5"><span className="pdot" style={{background:"#7c3aed"}}/></div>}
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="inline-block bg-purple-100 text-purple-700 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4">What We Offer</span>
            <h2 className="text-4xl font-black text-gray-900 mb-4">Eight Features, One Platform</h2>
            <p className="text-gray-500 max-w-lg mx-auto">Everything a student needs to make a confident career decision. Click any card to learn more.</p>
          </div>
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
            {services.map((s,i)=>(
              <div key={i} onClick={()=>setSelected(s)}
                ...
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mb-5 bg-gradient-to-br ${s.grad} shadow-md`}>{s.icon}</div>
                <span className="text-xs font-bold text-purple-600 bg-purple-50 border border-purple-100 px-3 py-1 rounded-full mb-3 inline-block">{s.tag}</span>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <span className="inline-block bg-purple-100 text-purple-700 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4">Why AimRoute</span>
            <h2 className="text-4xl font-black text-gray-900 mb-4">How We're Different</h2>
            <p className="text-gray-500">Most career guidance is a Google search or a well-meaning uncle's advice.</p>
          </div>
          <div className="rounded-3xl overflow-hidden border border-gray-100" style={{boxShadow:"0 8px 40px rgba(124,58,237,0.1)"}}>
            <div className="grid grid-cols-3 px-8 py-5" style={{background:"linear-gradient(135deg,#7c3aed,#6366f1)"}}>
      ...
      <section className="py-24 px-6"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="inline-block bg-white/10 border border-white/20 text-purple-300 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4">Student Stories</span>
            ...
            {testimonials.map((t,i)=>(
              <div key={i} className="card-lift relative bg-white/5 backdrop-blur border border-white/10 rounded-3xl p-6 flex flex-col overflow-hidden">
                ...
                <div className="text-7xl font-black leading-none mb-1 select-none"
                  style={{fontFamily:"Georgia,serif",color:"rgba(255,255,255,0.06)",lineHeight:0.8}}>"</div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <span className="inline-block bg-purple-100 text-purple-700 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4">FAQ</span>
      ...
      <section className="relative py-24 px-6 overflow-hidden"
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-5xl font-black text-white mb-5 leading-tight">Ready to Find Your<br/>Direction?</h2>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 px-4"
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden"
            ...
            <div className={`bg-gradient-to-r ${selected.grad} p-8`}>
              <div className="w-14 h-14 bg-white/25 rounded-2xl flex items-center justify-center text-3xl mb-4">{selected.icon}</div>
            ...
            <div className="p-8">
              ...
              <div className="flex gap-3">
                {/* ── FIX: navigate to selected.navTo instead of always /career-path ── */}
                <button onClick={()=>{ setSelected(null); navigate(selected.navTo||"/career-path"); }}
